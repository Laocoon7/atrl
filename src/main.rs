...
fn main() {
    ...
    // game related
    setup_resources(&mut app); // TODO: How much of this can we turn into loading systems to hide behind a Splash Screen / Loading Screen?
    load_plugins(&mut app); // TODO: How much of this can we turn into loading systems to hide behind a Splash Screen / Loading Screen?
