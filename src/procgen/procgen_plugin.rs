...
//     fn setup(ctx: Res<GameContext>, mut commands: Commands, mut state:
// ResMut<CurrentState<S>>) {         let (start_x, start_y) = random_start_position(&mut
// ctx.get_rng());         let chain = BuilderChain::new(0, [80, 50], "New Map")
