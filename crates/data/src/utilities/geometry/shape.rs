...
pub trait Shape {
    ...
    fn move_to(&self, point: impl GridPoint) -> Self
    where Self: Sized {
    ...
    fn rotate_around(&self, point: impl GridPoint, degrees: f32) -> Self
    where Self: Sized {
    ...
    fn scale_around(&self, point: impl GridPoint, factor: f32) -> Self
    where Self: Sized {
