...
impl Rectangle {
    ...
    #[inline]
    pub fn contains(&self, point: impl GridPoint) -> bool {
...
impl<P: GridPoint> Add<P> for Rectangle {
    type Output = Self;
...
where Rectangle: Add<T, Output = Rectangle>
{
...
impl<P: GridPoint> Sub<P> for Rectangle {
    type Output = Self;
...
where Rectangle: Sub<T, Output = Rectangle>
{
...
impl<P: GridPoint> Mul<P> for Rectangle {
    type Output = Rectangle;
...
where Rectangle: Mul<T, Output = Rectangle>
{
...
impl<P: GridPoint> Div<P> for Rectangle {
    type Output = Rectangle;
...
where Rectangle: Div<T, Output = Rectangle>
{
