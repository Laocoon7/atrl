...
impl<T: GridParam, const LAYER_COUNT: usize> Grid3d<T, LAYER_COUNT> {
    ...
    pub fn new_default(size: impl Size2d) -> Self
        ...
        for _ in 0..LAYER_COUNT {
            let mut layer = Grid::<T>::new_default(size);
            layer.resize_with(count, Default::default);
            layers.push(layer);
        }
    ...
    pub fn new_fn(size: impl Size2d, f: impl Fn((usize, IVec2)) -> T) -> Self {
        ...
        for index in 0..LAYER_COUNT {
            ...
            layers.push(Grid::<T> {size: size.as_uvec2(), cells});
        }
    ...
    pub fn blit_clone<ToLayerId: Into<usize>, FromLayerId: Into<usize>>(&mut self, to_layer_id: ToLayerId, to: impl Point2d, source: &Self, from_layer_id: FromLayerId, from: impl Point2d, size: impl Size2d)
        where T: Clone {
    ...
    pub fn blit_copy<ToLayerId: Into<usize>, FromLayerId: Into<usize>>(&mut self, to_layer_id: ToLayerId, to: impl Point2d, source: &Self, from_layer_id: FromLayerId, from: impl Point2d, size: impl Size2d)
        where T: Copy {
            if let Some(to_layer) = self.get_grid_by_layer_mut(to_layer_id) {
                if let Some(from_layer) = source.get_grid_by_layer(from_layer_id) {
    ...
    pub fn blit_clone_from_2d<ToLayerId: Into<usize>>(&mut self, to_layer_id: ToLayerId, to: impl Point2d, source: &Grid<T>, from: impl Point2d, size: impl Size2d)
        where T: Clone {
            if let Some(to_layer) = self.get_grid_by_layer_mut(to_layer_id) {
    ...
    pub fn blit_copy_from_2d<ToLayerId: Into<usize>>(&mut self, to_layer_id: ToLayerId, to: impl Point2d, source: &Grid<T>, from: impl Point2d, size: impl Size2d)
        where T: Copy {
            if let Some(to_layer) = self.get_grid_by_layer_mut(to_layer_id) {
    ...
    pub fn blit_clone_to_2d<FromLayerId: Into<usize>>(&self, from_layer_id: FromLayerId, from: impl Point2d, dest: &mut Grid<T>, to: impl Point2d, size: impl Size2d)
        where T: Clone {
    ...
    pub fn blit_copy_to_2d<FromLayerId: Into<usize>>(&self, from_layer_id: FromLayerId, from: impl Point2d, dest: &mut Grid<T>, to: impl Point2d, size: impl Size2d)
        where T: Copy {
            if let Some(from_layer) = self.get_grid_by_layer(from_layer_id) {
    ...
    #[inline]
    pub fn get_mut<LayerId: Into<usize>>(&mut self, layer_id: LayerId, index: impl Point2d) -> Option<&mut T> {
    ...
    #[inline]
    pub fn get_mut_unchecked<LayerId: Into<usize>>(&mut self, layer_id: LayerId, index: impl Point2d) -> &mut T {
        self.layers[layer_id.into()].get_mut_unchecked(index)
    }

    #[inline]
    pub fn set<LayerId: Into<usize>>(&mut self, layer_id: LayerId, index: impl Point2d, value: T) -> Option<T> {
        if let Some(layer) = self.get_grid_by_layer_mut(layer_id) {
    ...
    #[inline]
    pub fn set_unchecked<LayerId: Into<usize>>(&mut self, layer_id: LayerId, index: impl Point2d, value: T) -> T {
